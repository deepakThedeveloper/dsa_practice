...
public class MinInsertionToMakeStringPalindrome {
    public static void main(String[] args) {
        ...
        int minInsertion = s1.length() - lcs1;
        System.out.println("memoization revision:"+minInsertion);

        int lcs2 = lpsTabulationRevision(s1, s2);
        int minInsertion1 = s1.length() - lcs2;
        System.out.println("tabulation revision:"+minInsertion1);
